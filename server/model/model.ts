...
import { OrganisationSchema, IOrganisation } from "./schema/organisation.schema";
import { BloodRequestSchema, IBloodRequest } from "./schema/blood-request.schema";
import { DonationLocationSchema, IDonationLocation } from "./schema/donation-location.schema";
...
const BloodRequest: Model<IBloodRequest> = mongoose.model<IBloodRequest>('BloodRequest', BloodRequestSchema);
const DonationLocation: Model<IDonationLocation> = mongoose.model<IDonationLocation>('DonationLocation', DonationLocationSchema);
