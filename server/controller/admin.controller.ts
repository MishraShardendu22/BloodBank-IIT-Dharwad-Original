...
const register = async (req: Request, res: Response) => {
    try {
        ...
        return ResponseApi(res, 500, error instanceof Error ? error.message : 'An unknown error occurred while registering the admin');
    }
};
...
const login = async (req: Request, res: Response) => {
    try {
        ...
        return ResponseApi(res, 500, error instanceof Error ? error.message : 'An unknown error occurred while logging in the admin');
    }
};
